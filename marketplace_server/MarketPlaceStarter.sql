...
Create Table Conversations (
    ...
    cardID int(11) not null,
    messagesJson text,
    numberOfMessages int(11) Default 0,
    time timestamp not null Default current_timestamp(),
    ...
    INSERT INTO Conversations (user_id_1, user_id_2, cardID) values (1, 3, 1);
    INSERT INTO Conversations (user_id_1, user_id_2, cardID) values (3, 1, 1);

    INSERT INTO Conversations (user_id_1, user_id_2, cardID) values (1, 2, 3);
    INSERT INTO Conversations (user_id_1, user_id_2, cardID) values (2, 1, 3);
    
    INSERT INTO Conversations (user_id_1, user_id_2, cardID) values (2, 1, 2);
    INSERT INTO Conversations (user_id_1, user_id_2, cardID) values (1, 2, 2);
